                ...
                @if($d->barang->show == 1)
                  <tr>
                    ...
                    <td style="text-align:left;">
                      <a href="{{ route('transaksi_barang.destroy', $d->id) }}"
                         class="btn btn-danger hapus">Hapus</a>
    ...
    <div class="modal-content">
      ...
      <form action="{{ route('transaksi_barang.add') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <input type="number" name="qty" class="form-control" placeholder="Masukan qty transaksi barang"
                   required>
          </div>
          <div class="form-group">
            <input type="date" name="tanggal_transaksi" class="form-control"
                   placeholder="Masukan tanggal transaksi barang" required>
          </div>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <input id="qty" type="number" name="qty" class="form-control"
                   placeholder="Masukan qty transaksi barang" required>
          </div>
          <div class="form-group">
            <input id="tanggal_transaksi" type="date" name="tanggal_transaksi" class="form-control"
                   placeholder="Masukan tanggal transaksi barang" required>
          </div>
        </div>
        <div class="modal-footer">
