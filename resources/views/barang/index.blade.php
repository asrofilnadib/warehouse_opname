        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <input type="text" name="nama_konversi" class="form-control" placeholder="Masukan Nama Konversi" required>
              </div>
              <div class="form-group">
      ...
      <div class="modal fade" id="editData" tabindex="-1" role="dialog" aria-labelledby="editDataLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                <input id="nama_barang" type="text" name="nama_barang" class="form-control" placeholder="Masukan Nama Barang" required>
              </div>
              <div class="form-group">
                <input id="nama_konversi" type="text" name="nama_konversi" class="form-control" placeholder="Masukan Nama Konversi" required>
              </div>
              <div class="form-group">
                <select name="id_satuan" id="id_satuan" class="form-control">
                  <option value="" selected>-- Pilih Satuan Barang --</option>
              ...
              <div class="form-group">
                <input id="stock" type="number" name="stock" class="form-control" placeholder="Masukan stock barang" required>
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
